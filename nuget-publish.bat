:start
::定义版本
set EFCORE8=7.8.1.19-preview2
set EFCORE7=7.7.1.19-preview2
set EFCORE6=7.6.1.19-preview2
set EFCORE5=7.5.1.19-preview2
set EFCORE3=7.3.1.19-preview2
set EFCORE2=7.2.1.19-preview2
